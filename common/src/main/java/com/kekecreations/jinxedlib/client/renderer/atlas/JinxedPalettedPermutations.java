...
public class JinxedPalettedPermutations implements SpriteSource {
    ...
    static record JinxedPalettedSpriteSupplier(LazyLoadedImage baseImage, Supplier<IntUnaryOperator> paletteSupplier, ResourceLocation permutationLocation) implements SpriteSource.SpriteSupplier {


        JinxedPalettedSpriteSupplier(LazyLoadedImage baseImage, Supplier<IntUnaryOperator> paletteSupplier, ResourceLocation permutationLocation) {
        ...
        public SpriteContents apply(SpriteResourceLoader loader) {
            ...
            try {
                ...
                var2 = new SpriteContents(this.permutationLocation, new FrameSize(nativeImage.getWidth(), nativeImage.getHeight()), nativeImage, ResourceMetadata.EMPTY);
                return var2;
